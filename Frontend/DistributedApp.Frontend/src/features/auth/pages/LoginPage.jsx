...
// Usaremos el icono 'Command' o 'Lock' para un look tech/Apple
import { Lock, User, ArrowRight, Loader2, Eye, EyeOff, Command } from "lucide-react"; 
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          >
            {loading ? (
              ...
              <>
                Continuar <ArrowRight size={18} className="ml-2 opacity-80" strokeWidth={2} />
              </>
            )}
          </button>
        </form>
