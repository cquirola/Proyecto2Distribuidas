      ...
      const RoleBadge = ({ role }) => {
        ...
        return (
          <span
            className={`ml-3 inline-flex items-center rounded-full px-3 py-1 text-xs font-semibold ${
              isAdmin
      ...
      const DashboardPage = () => {
        ...
        // Si prefieres deshabilitar módulos no permitidos (en vez de ocultarlos):
        //const visible = modules.map((m) => ({...m, disabled: !m.allowed(normalizedRole),}));

        // Si prefieres ocultarlos:
